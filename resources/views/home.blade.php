  ...
  <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
    <div class="navbar-nav" style="padding-left: 642px;">
           ...
           <li class="nav-item dropdown">
                ...
                <a id="navbarDropdown" style="color: white;" class="nav-link dropdown-toggle text-center"  role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" v-pre>
